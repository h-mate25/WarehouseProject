        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedItemSKU = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipmentItems", x => new { x.ShipmentId, x.SKU });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Workers",
                columns: new[] { "Id", "CreatedAt", "Department", "Email", "FullName", "IsActive", "LastLogin", "PasswordHash", "PhoneNumber", "Role", "Username" },
                values: new object[] { 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "IT", "admin@warehouse.com", "System Administrator", true, null, "AQAAAAIAAYagAAAAECCSbGm+Pv6mxIBm7Wy3D0Aoc5IfmS1lU3L1CqjuCsmx/k3evvgbCOqeOL3qVRMcIA==", null, "Admin", "admin" });
